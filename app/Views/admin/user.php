...
<style>
    ...
    .user-avatar-inline { width: 34px; height: 34px; border-radius: 9px; background: #1a1a1a; color: #fff; display: grid; place-items: center;  font-size: 0.82rem; font-weight: 800; margin-right: 10px; vertical-align: middle; flex-shrink: 0; }
...
<div class="users-table-wrap">
    <table class="users-table">
        ...
        <td><?= (new \App\Models\ApplicationModel())->where('id_pengguna', $userItem['id'])->countAllResults() ?></td>
        <td><?= date('d M Y', strtotime($userItem['dibuat_pada'])) ?></td>
        <td>
            <span class="badge<?= !empty($userItem['aktif']) ? ' succes' : ' danger' ?>">
