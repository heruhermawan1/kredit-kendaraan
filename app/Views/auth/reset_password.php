...
<div class="auth-page">
    <div class="auth-visual">
        ...
        <div class="auth-visual-content">
            ...
            <div class="auth-visual-quote">
                ...
                <p>Masukkan password baru agar Anda bisa kembali masuk ke akun AutoKredit.</p>
            </div>
        </div>
    </div>
    <div class="auth-form-side">
        <div class="auth-form-box">
            ...
            <p class="auth-sub">Isi password baru anda di bawah ini.</p>
        ...
        <form action="/reset-password" method="post">
            ...
            <div class="auth-field form-control">
                ...
                <input class="password-toggle" type="password" id="password" placeholder="Masukan password baru" name="password" required>
                <p id="password-strength" class="auth-hint" style="margin-top: 8px;">&nbsp;</p>  
            </div>
            <div class="auth-field form-control">
                <label for="confirm_password">Konfirmasi password</label>
                <input class="password-toggle" type="password" id="confirm_password" placeholder="Ulangi password baru" name="confirm_password" required>
            </div>
